unit Spring.Persistence.Adapters.ObjectDataset;

interface

uses
  Spring.Persistence.Adapters.ObjectDataset.Abstract
  ,Spring.Persistence.Adapters.ObjectDataset.ExprParser
...
uses
  ...
  ,Spring.SystemUtils
  ,DateUtils
  ,Spring.Persistence.Adapters.ObjectDataset.ExprParser.Functions
  ;
