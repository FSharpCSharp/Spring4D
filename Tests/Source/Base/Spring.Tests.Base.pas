...
{$ENDIF}
  ...
  public
    class function xxHash32Hash: TArray<THashTestData>; static;
    class function Murmur3Hash: TArray<THashTestData>; static;
  published
    [TestCaseSource('xxHash32Hash')]
    [TestCaseSource('Murmur3Hash')]
    procedure TestHash(const test: THashTestData);
  end;

const
  // sequence of '0' - hashcode generated by https://asecuritysite.com/encryption/xxHash
  xxHash32Tests: array[0..18] of THashTestData = (
    (Kind: xxHash32; Len: 0; Expected: $02cc5d05),
    (Kind: xxHash32; Len: 1; Expected: $48454cb2),
    (Kind: xxHash32; Len: 2; Expected: $a10f97fb),
    (Kind: xxHash32; Len: 3; Expected: $b35d055d),
    (Kind: xxHash32; Len: 4; Expected: $9631b8ca),
    (Kind: xxHash32; Len: 5; Expected: $4c1d9b7d),
    (Kind: xxHash32; Len: 6; Expected: $64e88605),
    (Kind: xxHash32; Len: 7; Expected: $b5fd9c55),
    (Kind: xxHash32; Len: 8; Expected: $76b3c248),
    (Kind: xxHash32; Len: 15; Expected: $fe6db0ac),
    (Kind: xxHash32; Len: 16; Expected: $b1d27727),

    (Kind: xxHash32; Len: 17; Expected: $10e66183),
    (Kind: xxHash32; Len: 18; Expected: $f44e0598),
    (Kind: xxHash32; Len: 19; Expected: $0a06e9ed),
    (Kind: xxHash32; Len: 20; Expected: $a083d0dd),
    (Kind: xxHash32; Len: 21; Expected: $9e12819c),
    (Kind: xxHash32; Len: 22; Expected: $04284898),
    (Kind: xxHash32; Len: 23; Expected: $a4cac047),

    (Kind: xxHash32; Len: 33; Expected: $f6d126f1)
  );

  // sequence of '0' - hashcode generated by https://asecuritysite.com/encryption/smh_murmur
  Murmur3HashTests: array[0..18] of THashTestData = (
    (Kind: Murmur3Hash; Len: 0; Expected: 0),
    (Kind: Murmur3Hash; Len: 1; Expected: $d271c07f),
    (Kind: Murmur3Hash; Len: 2; Expected: $8ff7b62d),
    (Kind: Murmur3Hash; Len: 3; Expected: $8a087382),
    (Kind: Murmur3Hash; Len: 4; Expected: $978c03a4),
    (Kind: Murmur3Hash; Len: 5; Expected: $5d9c3839),
    (Kind: Murmur3Hash; Len: 6; Expected: $b9acf9a4),
    (Kind: Murmur3Hash; Len: 7; Expected: $458cb4bc),
    (Kind: Murmur3Hash; Len: 8; Expected: $98e7eb0b),
    (Kind: Murmur3Hash; Len: 15; Expected: $edc0249b),
    (Kind: Murmur3Hash; Len: 16; Expected: $129545e4),

    (Kind: Murmur3Hash; Len: 17; Expected: $c5a57bb0),
    (Kind: Murmur3Hash; Len: 18; Expected: $34606f71),
    (Kind: Murmur3Hash; Len: 19; Expected: $7f79b2b1),
    (Kind: Murmur3Hash; Len: 20; Expected: $54ce5018),
    (Kind: Murmur3Hash; Len: 21; Expected: $a46b8ae6),
    (Kind: Murmur3Hash; Len: 22; Expected: $9f784a89),
    (Kind: Murmur3Hash; Len: 23; Expected: $75b7dc65),

    (Kind: Murmur3Hash; Len: 33; Expected: $581f1dd6)
  );
...
class function TTestHash.xxHash32Hash: TArray<THashTestData>;
begin
  Result := TArray.Copy<THashTestData>(xxHash32Tests);
end;

class function TTestHash.Murmur3Hash: TArray<THashTestData>;
begin
  Result := TArray.Copy<THashTestData>(Murmur3HashTests);
end;

procedure TTestHash.TestHash(const test: THashTestData);
const
...
var
  data: TBytes;
begin
  SetLength(data, test.Len);
  FillChar(Pointer(data)^, test.Len, Ord('0'));
  CheckEquals(Cardinal(test.Expected), Cardinal(HashFunction[test.Kind](Pointer(data)^, test.Len)));
end;
