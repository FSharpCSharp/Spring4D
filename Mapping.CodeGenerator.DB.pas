...
begin
  ...
  try
    ...
    begin
      ...
      LColumnData.IsPrimaryKey := FPrimaryKeys.TryGetValue(GetPrimKeyFindKey(LTable, LSchema, LColumnData.ColumnName), LOut);
...
begin
  ...
  case AField.DataType of
    ...
    begin
      ...
      else if Result = 'Date' then
        Result := 'TDate'
      else if Result = 'Time' then
        Result := 'TTime'
      else if Result = 'DateTime' then
        Result := 'TDateTime'
      else if Result = 'LargeInt' then
        Result := 'Int64';
    end;
  end;

  if not AField.Required then
  begin
