...
begin
  ...
  begin
    ...
    TRttiExplorer.SetMemberValueSimple(AEntity, EntityData.VersionColumn.ClassMemberName, 0);
  end;
  ...
  begin
    TRttiExplorer.SetMemberValue(nil, AEntity, EntityData.PrimaryKeyColumn
  ...
  try
    ...
    if CanGetSequenceValue then
    begin
      TRttiExplorer.SetMemberValue(nil, AEntity, EntityData.PrimaryKeyColumn, TValue.FromVariant(LSequenceValue));
    end;
