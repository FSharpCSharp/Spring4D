...
begin
  ...
  if CanClientAutogenerateValue then
    TRttiExplorer.SetMemberValue(nil, entity, EntityData.PrimaryKeyColumn,
  ...
  try
    ...
    if CanGetSequenceValue then
      TRttiExplorer.SetMemberValue(nil, entity, EntityData.PrimaryKeyColumn, TValue.FromVariant(LSequenceValue));
  finally
    LStmt := nil;
    LResultset := nil;
  end;
...
begin
  ...
  TRttiExplorer.SetMemberValue(nil, entity, fAutoGeneratedName, TValue.FromVariant(LID));
end;
