...
procedure EncryData(keyData, inData: array of Byte; var outData: array of Byte);
procedure DecryData(keyData, inData: array of Byte; var outData: array of Byte);
...
procedure desData(desMode: TDesMode; keyData, inData: array of Byte; var outData: array of Byte);
