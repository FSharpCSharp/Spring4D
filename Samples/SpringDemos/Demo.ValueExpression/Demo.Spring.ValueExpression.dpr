program Demo.Spring.ValueExpression;
...
begin
  try
    ...
    try
      ...
      WriteLn('PublicString from EvaluateExpression call: ', EvaluateExpression('PublicString', VE).Value.ToString);
      WriteLn('VE.Expression: ', VE.Expression);
