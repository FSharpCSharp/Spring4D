...
///	<summary>Defines the <c>BigDecimal</c> data type.</summary>
unit Spring.Numerics.BigDecimal;
interface
uses SysUtils,
     Variants,
     Spring,
...
begin
  ...
  then
    TArgument.RaiseArgumentFormatException('AString');
end;
...
begin
  ...
  if ANewScale < 0 then
    TArgument.RaiseArgumentOutOfRangeException('ANewScale');
